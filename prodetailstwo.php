...
<body>
    ...
    <div class="col-1 details">
        ...
        <div class="col-4 single-product" style="padding-left: 30px;">
           ...
           <form action="<?php echo isset($userId) ? 'cart.php' : null ?>" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="item2" value="<?php echo $item['item']; ?>">
                <input type="hidden" name="price2" value="<?php echo $item['price']; ?>">
                <input type="hidden" name="itemid2" value="<?php echo $item_id; ?>">
                <input type="hidden" name="userid2" value="<?php echo isset($userId) ? $userId: 0 ; ?>">
                <input type="number" name="units2" value="1" id="name">
                <input type="hidden" name="img2" value="<?php echo $item['image']; ?>">
    ...
    <div class="col-1 single-product" style="padding-left: 30px;">
        ...
        <div class="col-1 listbox1">
           <?php
               ...
               getRelatedProducts($item_id,'products',$userId);
    ...
    <div id="demo" class="hide">
        ...
        <form action="userCartProcess.php" method="POST" id="signup">
            ...
            <br>
            <button type="submit" name="submit3" class="exp-btn btn-a btn"  onclick="close1();">Login</button>
