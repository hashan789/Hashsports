...
<body>
    ...
    <div class="col-1">
        ...
        <div class="col-4">
            ...
            <p class="font1 center">To keep connected with us please login with your personal account by email address or username and password</p>
        </div>
    </div>
    <div class="col-1 centerele">
        <div class="col-3 border-log" style="height:800px;">
            <div class="form-btn">
               <span class="font1" style="text-align: center;">Login</span>
            </div>
        <br>
        <div class="centerele">
        <form action="userProcess.php" method="POST" id="signup" enctype="multipart/form-data">
            <input type="text" placeholder="username" name="userName">
            <input type="password" placeholder="Password" name="password">
            <br>
            <button type="submit" class="exp-btn btn-a btn" name="submit">Login</button>
