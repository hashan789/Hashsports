...
<div class="row">
    ...
    <div class="col-1">
        <div class="col-4 form-row">
                <h1 class="font2" style="text-align: center;margin-top:50px;">Resest your password</h1>
            <form action="<?php echo sprintf('repassProcess.php?userId=%d',$userId1) ?>" style="text-align: center;padding:50px;" method="POST">
                <input type="text" value="" name="rePassword" placeholder="Enter Your Repassword">
                <input type="hidden" name="userid" value="<?php echo $userId1; ?>"><br style="margin-bottom:50px;">
