...
<div class="row">
    ...
    <div class="col-1">
        ...
        <div class="col-4">
            <h2 class="font2 center big">This is your verification</h2>
            <p class="font1 center">Thank you for registering. we have sent a verification email to the address provided.</p>
        </div>
    </div>
