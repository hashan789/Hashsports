...
<div class="row">
    ...
    <div class="col-1">
        ...
        <div class="col-4">
            <h2 class="font2 center big"><?php echo $_SESSION['head']; ?></h2>
            <p class="font1 center"><?php echo $_SESSION['error']; ?></p>
        </div>
    </div>
    <div class="col-1 bg-down">
        ...
        <div class="col-1">
           <h4 class="font1">&#169; hashsports 2021 Inc. | All Rights Reserved.</h4>
        </div>
    </div>
</body>
</html>