<?php
   ...
   foreach($product->getData('latestproducts') as $item):
...
<body>
    ...
    <div class="col-1 details">
        ...
        <div class="col-4 single-product" style="padding-left: 30px;">
           ...
           <form action="<?php echo isset($userId) ? 'cart.php' : null ?>" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="item1" value="<?php echo $item['item']; ?>">
                <input type="hidden" name="price1" value="<?php echo $item['price']; ?>">
                <input type="hidden" name="itemid1" value="<?php echo $item_id; ?>">
                <input type="hidden" name="userid1" value="<?php echo isset($userId) ? $userId: 0 ; ?>">
                <input type="number" name="units1" value="1" id="name">
                <input type="hidden" name="img1" value="<?php echo $item['image']; ?>">
                <button class="btn-a btn-1" name="submit" id="btn-form"><a class="font1" style="text-decoration: none;color:white;">Add to cart</a></button>
            </form>
            <?php
                 if(!isset($userId)):
            ?>
    ...
    <div class="col-1 single-product" style="padding-left: 30px;">
        ...
        <div class="col-1 listbox1">
           <?php
               ...
               getRelatedProducts($item_id,'latestproducts',$userId);
    ...
    <div id="demo" class="hide">
        ...
        <form action="userCartProcess.php" method="POST" id="signup">
            ...
            <br>
            <button type="submit" name="submit2" class="exp-btn btn-a btn"  onclick="close1();">Login</button>
