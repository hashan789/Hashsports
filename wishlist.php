...
<body>
    ...
    <div class="col-1 single-product" style="padding-left: 30px;">
      <div class="col-1">
       <select name="" id="" class="data font1 right" style="margin-bottom: 10px;">
        ...
        <h1 class="font1 left">Wishlist</h1>
      </div>
      <div class="col-1">
        <div class="listbox1">
        <?php
            ...
            if($result){
                ...
                if($count > 0){
                    ...
                    echo "</ul>";
                        ...
                        echo "<h2 class='font3' style='text-align:center;margin-top:30px;margin-bottom:30px;'>No items is selected!</h2>";
                    }
                }
    ...
    <footer>
    <div class="col-1 bg-down bg-down1">
        <div class="col-5">
